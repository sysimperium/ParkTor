...
Este documento define as regras para o uso do Git e GitHub no projeto ParkTor, visando manter um histórico limpo, rastreável e integrado ao fluxo de deploy.
